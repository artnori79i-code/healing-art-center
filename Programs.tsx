                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="bg-orange-600 p-8 md:p-12 text-white">
                      ...
                      <p className="text-white/80 text-sm md:text-lg font-medium leading-relaxed max-w-3xl">
                        고양시 노인종합복지관 관내 모든 경로당 문화예술교육 순회사업에서 힐링예술터는 시니어 회원들께 음악 중심의 문화예술교육과 예술치유를 진행했습니다.
                        힐링예술터는 어르신들과 함께하며, 악기 연주와 신체 활동을 통해 소외된 이웃 없이 모두가 예술의 주인공이 되는 소중한 시간을 만들었습니다.
                      </p>
                    </div>
