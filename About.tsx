          ...
          <div className="flex flex-col md:grid md:grid-cols-2 gap-10 lg:gap-16 items-start text-left w-full">
            ...
            <div className="space-y-8 py-4">
              ...
              <p className="text-neutral-500 text-[15px] md:text-[18px] leading-[2.2] font-medium w-full md:max-w-none text-left break-words px-1">
                <span className="font-semibold text-neutral-700">2011년</span> 첫걸음을 뗀 이후, <span className="font-semibold text-neutral-700">전국 200여 개 공공기관</span>과 <span className="font-semibold text-neutral-700">국방부 전 군(육·해·공·해병대)</span>의 현장에서 고유한 예술적 가치를 실현해 왔습니다. <span className="font-semibold text-neutral-700">15년</span>이라는 시간 동안 마주한 <span className="font-semibold text-neutral-700">문화예술교육</span>은 단순한 기술 전수를 넘어, <span className="font-semibold text-neutral-700">개인의 감각</span>을 깨우고 <span className="font-semibold text-neutral-700">공동체의 결속</span>을 돕는 <span className="font-semibold text-neutral-700">'삶의 현장'</span> 그 자체였으며, 평범한 일상을 미학으로 재해석하는 고품격 프로그램을 통해 우리 곁에 스며든 예술이 더 나은 세상을 향한 <span className="font-semibold text-neutral-700">창의적 솔루션</span>이 될 수 있도록 <span className="font-semibold text-neutral-700">신뢰와 열정</span>으로 함께하겠습니다.
              </p>
              ...
              <div className="space-y-12">
                ...
                <div className="space-y-6">
                  ...
                  <ul className="text-[14px] text-neutral-500 space-y-3 font-medium leading-relaxed">
                    ...
                    <li>• 연세대학교 신학과 졸업</li>
                    <li className="font-bold text-neutral-800">• 국방부 문화예술교육 기획/운영/연구</li>
                    <li className="font-bold text-neutral-800">• 서울디지털대학교 음악치료교육 반주법 교수</li>
                    <li>• 이화여자대학교 예술교육치료연구소 연구원</li>
                  </ul>
                </div>
                ...
                <div className="pt-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
                  ...
                  >
                    <span className="text-[10px] font-black tracking-wider uppercase text-neutral-800">세부 프로필</span>
                  ...
                  <div className="space-y-10">
                    ...
                    <div className="space-y-8 text-neutral-500 leading-relaxed font-medium">
                      <p className="text-[15px] md:text-base">
                        저는 음악이 지닌 단단한 구조적 아름다움과 따스한 정서적 위로가 어떻게 다른 예술 장르, 그리고 우리 삶의 교육적 가치와 맞닿을 수 있을지 깊이 고민해 왔습니다. 저의 근간을 형성한 통합적 문화예술교육, 음악교육, 음악치료교육학 토대 위에서 성장했으며, 이를 우리 곁의 보편적인 문화예술교육 안에서 그 치유적 온기로 자연스럽게 녹여내고자 마음을 다해왔습니다.
                      </p>
