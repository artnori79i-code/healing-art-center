          ...
          <div className="flex flex-col md:grid md:grid-cols-2 gap-10 lg:gap-16 items-start text-left w-full">
            ...
            <div className="space-y-8 py-4">
              ...
              <p className="text-neutral-500 text-[15px] md:text-[18px] leading-[2.2] font-medium w-full md:max-w-none text-left break-words px-1">
                <span className="font-bold text-neutral-800">2011년</span> 첫걸음을 뗀 이후, <span className="font-bold text-neutral-800">전국 200여 개 공공기관</span>과 <span className="font-bold text-neutral-800">국방부 전 군(육·해·공·해병대)</span>의 현장에서 고유한 예술적 가치를 실현해 왔습니다. <span className="font-bold text-neutral-800">15년</span>이라는 시간 동안 마주한 <span className="font-bold text-neutral-800">문화예술교육</span>은 단순한 기술 전수를 넘어, <span className="font-bold text-neutral-800">개인의 감각</span>을 깨우고 <span className="font-bold text-neutral-800">공동체의 결속</span>을 돕는 <span className="font-bold text-neutral-800">'삶의 현장'</span> 그 자체였으며, 평범한 일상을 미학으로 재해석하는 고품격 프로그램을 통해 우리 곁에 스며든 예술이 더 나은 세상을 향한 <span className="font-bold text-neutral-800">창의적 솔루션</span>이 될 수 있도록 <span className="font-bold text-neutral-800">신뢰와 열정</span>으로 함께하겠습니다.
              </p>
