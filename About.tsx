                  ...
                  <div className="space-y-10">
                    ...
                    <div className="space-y-8 text-neutral-500 leading-relaxed font-medium">
                      <p className="text-[15px] md:text-base">
                        저는 지난 15년이라는 시간 동안, 음악이 지닌 단단한 구조적 아름다움과 따스한 정서적 위로가 어떻게 다른 예술 장르, 그리고 우리 삶의 교육적 가치와 맞닿을 수 있을지 깊이 고민해 왔습니다. 학문적으로는 'Music Therapy 교육학' 토대 위에서 성장했으며, 이를 우리 곁의 보편적인 문화예술교육 안에서 그 치유적 온기로 자연스럽게 녹여내고자 마음을 다해왔습니다.
                      </p>
