        ...
        >
          <div className="grid md:grid-cols-2 gap-6 pt-4">
            <HistoryCard
              ...
              items={[
                "범국가적 문화예술지원사업 수행: 문화체육관광부 및 국방부 주관 '군부대 문화예술교육 지원사업' 음악 분야 [힐링예술터] 총괄 기획 및 운영",
                "육·해·공군 및 해병대 맞춤형 교육: 인천, 강화, 화성, 안산, 강원도 철원, 백령도, 연평도 등 전국 전방 부대 및 격오지 대상 수십여 개 문화예술교육/소개교육/군장병 공연 교육 커리큘럼 설계",
                "특수 공공기관 상설 교육: 용산경찰서 의경대상 밴드 예술 교육 기획 및 김포시 교육청 '기초학력심리센터'",
                "서울문화재단 전략 프로젝트: 성북예술창작센터 [이성경-힐링예술터] 4년간 입주작가로서 '상상음악공장', '동물의 왕국 뮤지컬', '새소망 노래 녹음방' 등 17개 혁신 교육 모델 개발"
              ]}
            />
            <HistoryCard
              delay={0.2}
              ...
              items={[
                "100여개 초·중·고교 문화예술교육 기획 및 교육 협약, 전교생 대상 장기 프로젝트: 동작초등학교(전교생 대상 창의예술체험), 서울시 교육청 등 수도권 수십여 개교와 협력하여 학기별 정규 프로그램 운영",
                "광역 지자체 교육지원사업: 서울시(동작구, 은평구, 성북구 등), 경기도(김포, 시흥 등) 관내 학교 및 센터 연계 예술 교육 서비스 제공",
                "인문·문학 융합 교육: 어린이도서연구회 협력 '예술동화탐험' 시리즈를 통한 독서 창작과 시각/음악 활동의 복합 설계",
                "미디어 기반 통합 교육: 세종시 협력 스마트폰·인터넷 중독 예방을 위한 '밴드 융합 소리놀이' 및 세종시 청소년 예술 치유 캠프 운영"
              ]}
            />
            <HistoryCard
              delay={0.3}
              ...
              items={[
                "고위험군 시니어 전문 교육: 고양시 대화노인종합복지관 우울증 및 자살 고위험군(F진단) 대상 예술 정서지원",
                "수도권 주요 노인종합복지관 거점 활동: 동작, 중계, 서초, 분당 등 주요 노인종합복지관 대상 상설 문화예술 교육 세션 진행",
                "특수 케어 및 데이케어: 성심치매노인기관, 역촌데이케어센터, 한우리정보문화센터 등 돌봄 기반 예술 활동 지원",
                "가족 및 보호자 지원: 서초구청 '치매 부양 가족을 위한 예술 정서요법' 등 보호자 대상 힐링 프로그램 특화"
              ]}
            />
            <HistoryCard
              delay={0.4}
              title="4. 기업 사회공헌(CSR) 및 의료기관 문화예술교육+예술치유 프로젝트"
              items={[
                "글로벌 기업 협력 실적: 사노피 아벤티스('싱싱엔돌핀', '함께해송'), GS칼텍스('마음톡톡'), 대웅제약 등 기업 연계 예술 솔루션 제공",
                "주요 대학병원 환자 정서지원: 한강성심(신경정신), 여의도성모, 한양대, 고려대병원 암센터 등 의료 현장 내 문화예술교육 +예술치유 접목 교육 적용",
                "2014 사노피 아벤티스 제약회사 후원사업 운영 <'암생존자/ 암환우 대상': '함께해송 프로그램' 기획자 및 주강사>",
                "(사)세계예술치료협회 <세계예술치유축제: 장애-비장애형제를 위한 왁자지껄 예술치유축제, 아싸라비아!> 10년 이상 매해 꾸준히 참여 함",
                "사회복지재단 협력: 삼성꿈장학재단, 초록우산 어린이재단, 하이패밀리 등과 연계한 취약계층 예술 복지 실현"
              ]}
            />
          </div>
        </motion.div>
