...
export const REVIEWS: Review[] = [
  ...
  { id: 9, name: "오영수", role: "시니어(72세)", program: "두 번째 청춘 악기", content: "이 나이에도 무언가를 배울 수 있다는 게 꿈만 같습니다. 인생의 하이라이트 무대였어요. 손끝에서 피어나는 멜로디와 함께 제 인생에도 새로운 봄날이 찾아온 것 같아 매일 아침 악기를 만지는 순간이 설렙니다.", image: "https://images.unsplash.com/photo-1506157786151-b8491531f063?q=80&w=400&h=400&auto=format&fit=crop" },
  { id: 10, name: "박순자", role: "시니어(68세)", program: "실버 리듬 합창단", content: "친구들과 함께 노래하며 우울함을 떨쳐냈습니다. 매주 이 시간이 기다려집니다. 혼자라고 느꼈던 시간들이 같은 목소리를 내는 동료들 덕분에 활기로 채워졌고, 제 삶의 가장 빛나는 화음을 찾았습니다.", image: "https://images.unsplash.com/photo-1552664730-d307ca884978?q=80&w=400&h=400&auto=format&fit=crop" },
  ...
  { id: 19, name: "김은지", role: "시니어 수강생", program: "회상 음악 활동", content: "과거의 기억들을 예술로 빚어내며 인생을 긍정하게 됐습니다. 참 따뜻한 시간이었어요. 잊고 지냈던 어린 시절의 노래와 악기 소리를 통해 삶의 발자취를 되돌아보니, 제 인생의 모든 순간이 소중한 작품이었음을 깨닫게 되었습니다.", image: "https://images.unsplash.com/photo-1551029122-0396dd32675d?q=80&w=400&h=400&auto=format&fit=crop" },
  ...
  { id: 21, name: "홍지민", role: "초등학교 교사", program: "창의 융합 예술 캠프", content: "아이들이 소리 없이 소통하는 법을 배우는 모습을 보며 예술교육의 힘을 실감했습니다. 서로의 다름을 화음으로 인정하는 과정은 그 어떤 교과서보다 훌륭한 인성 교육이었습니다. 아이들의 맑은 영혼이 예술로 피어나는 시간을 함께했습니다.", image: "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?q=80&w=400&h=400&auto=format&fit=crop" },
  { id: 22, name: "백경훈", role: "중소기업 대표", program: "CEO 예술 명상", content: "경영의 중압감에서 잠시 벗어나 정적 속의 선율을 만났습니다. 통찰력이 깊어지는 시간이었습니다. 소리에 집중하며 마음을 비우니 복잡했던 문제들이 단순해졌고, 직원들에게 더 따뜻하고 단단한 리더십을 보여줄 여유를 가졌습니다.", image: "https://images.unsplash.com/photo-1441986300917-64674bd600d8?q=80&w=400&h=400&auto=format&fit=crop" },
  { id: 23, name: "소예지", role: "중학생", program: "꿈꾸는 멜로디", content: "학교 학업 스트레스로 답답했던 마음이 악기 연주를 통해 시원하게 풀렸습니다. 친구들과 밴드 활동을 하며 제가 정말 좋아하는 것이 무엇인지 알게 되었고, 이제는 등굣길이 설레는 즐거운 학교 생활을 하고 있습니다.", image: "https://images.unsplash.com/photo-1514525253344-f81bad3b7c2a?q=80&w=400&h=400&auto=format&fit=crop" },
  ...
  { id: 25, name: "신혜수", role: "문화재단 팀장", program: "예술 복지 전문가 과정", content: "단순한 체험을 넘어 예술이 삶에 침투하는 방식을 심도 있게 고민한 수준 높은 연수였습니다. 현장에서 바로 적용 가능한 실전 팁들과 철학적인 바탕까지 고루 갖춘 교육 덕분에 향후 사업 기획에 큰 자신감을 얻었습니다.", image: "https://images.unsplash.com/photo-1517048676732-d65bc937f952?q=80&w=400&h=400&auto=format&fit=crop" },
  ...
  { id: 28, name: "탁재훈", role: "구청 공무원", program: "힐링 아트 데이", content: "지역 주민들과 어우러져 예술을 즐기는 모습에서 진정한 자치 교육의 의미를 찾았습니다. 행정적인 업무를 넘어 주민들의 행복한 웃음소리를 보며 제 일에 대한 보람을 다시 느꼈고, 문화로 하나 되는 마을의 가능성을 보았습니다.", image: "https://images.unsplash.com/photo-1528605248644-14dd04022da1?q=80&w=400&h=400&auto=format&fit=crop" },
  ...
  { id: 30, name: "남궁훈", role: "은퇴 교육자", program: "인생 제2막 아카이브", content: "수십 년간 교단을 지켰던 엄격함 대신 예술의 자유로움으로 제 노년을 꾸미게 되어 기쁩니다. 제가 직접 연주하는 음악이 제 인생의 마지막 장을 장식하는 사운드트랙처럼 느껴지며, 매일을 보물처럼 여기는 새로운 삶의 자세를 갖게 되었습니다.", image: "https://images.unsplash.com/photo-1506197394121-6a01799dc891?q=80&w=400&h=400&auto=format&fit=crop" }
];
...
export const PROGRAMS: Program[] = [
  ...
  },
  {
    ...
    subPrograms: [
      {
        id: "s1",
        title: "마음의 선율로 그리는 은빛 미소 (노인 우울 예방 예술 상담)",
        sessions: "12회기",
        participants: "15명 내외",
        content: "다채로운 악기의 음색으로 뇌를 깨우고, 잊혀진 기억의 편린들을 아름다운 선율 위에 다시 수놓습니다. 리듬에 맞춰 몸과 마음을 움직이며 고립감의 벽을 허물고, 서로의 하모니 속에서 우울을 넘어 삶의 생동감을 되찾는 예술적 신경 자극 중심의 집단 상담 프로그램입니다.",
