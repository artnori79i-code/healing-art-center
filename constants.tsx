...
export const PROGRAMS: Program[] = [
  {
    ...
    subPrograms: [
      ...
      },
      {
        ...
        image: "/images/army_program_3_v2.png"
      },
      {
        id: "d4",
        title: "병영문화예술 소개교육",
        ...
        content: "일일 체험형 예술을 매개로 개인의 예술적 역량을 발굴하고 병영 내 유연한 소통 문화를 정착시키는 문화예술교육 워크숍입니다. 악기 합주 과정은 장병 간의 심리적 거리감을 해소하며, 협업을 통한 실질적인 유대와 정서적 공감대를 형성합니다. <br /><br />장병들의 문화적 소외감을 해소하는 동시에 고유한 미적 경험을 제공하며, 참여형 합주 구성을 통해 강력한 그룹 성취감과 단합력을 고취합니다. 몰입도 높은 예술적 활동을 통해 직무 스트레스를 관리하고, 병영 생활의 에너지를 생산적이고 창의적인 예술 경험으로 재구조화하는 전문 문화예술교육 프로그램입니다.",
