...
export const PROGRAMS: Program[] = [
  {
    ...
    subPrograms: [
      ...
      },
      {
        ...
        sessions: "60분 내외",
        participants: "50~200명 내외",
        content: "일일 체험형 예술을 매개로 자기 내면의 울림과 타인의 숨결을 마주하는 소통 워크숍입니다. 낯선 악기의 선율이 병영의 공기를 부드럽게 감싸고, 장병 상호 간의 보이지 않는 경계를 허물며 깊은 유대와 공감의 결을 하나로 엮어갑니다. <br /><br />전문 아티스트들이 부대를 방문하여 선사하는 품격 있는 공연은 장병들의 문화적 갈증을 해소하며, 함께 호흡하며 만들어가는 웅장한 앙상블을 통해 강력한 그룹 성취감과 화합을 선사합니다. 악기 연주라는 몰입의 시간을 통해 병영의 스트레스를 예술적 에너지로 승화시키는 창의적인 치유의 현장입니다.",
