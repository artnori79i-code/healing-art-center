...
export const PROGRAMS: Program[] = [
  {
    ...
    subPrograms: [
      ...
      },
      {
        ...
        sessions: "60분 내외",
        participants: "50~200명 내외",
        content: "일일 체험형 예술을 매개로 개인의 예술적 역량을 발굴하고 병영 내 유연한 소통 문화를 정착시키는 문화예술교육 워크숍입니다. 악기 연주라는 공동의 과업 수행 과정은 장병 간의 심리적 거리감을 해소하며, 협업을 통한 실질적인 유대와 정서적 공감대를 형성합니다. <br /><br />현장 방문형 전문 아티스트 공연 프로젝트는 장병들의 문화적 소외감을 해소하는 동시에 고유한 미적 경험을 제공하며, 참여형 앙상블 구성을 통해 강력한 그룹 성취감과 단합력을 고취합니다. 몰입도 높은 예술적 활동을 통해 직무 스트레스를 관리하고, 병영 생활의 에너지를 생산적이고 창의적인 예술 경험으로 재구조화하는 전문 교육 프로그램입니다.",
